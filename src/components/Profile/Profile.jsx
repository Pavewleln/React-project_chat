...
const Profile = () =>{
    return(
        <div className={s.content}>
          <div className={s.top}>
            <img src="https://s0.rbk.ru/v6_top_pics/ampresize/media/img/3/06/755813427125063.jpg" alt=""/>
          </div>
          <div className={s.main}>
            <div className={s.profile}>
              ...
              <div className={s.description}>
                ...
                <div className={s.data}>
                  <ul>
                    <li>Дата рождения: да</li>
                    <li>Город: да</li>
                    <li>Образование: да</li>
                    <li>Хобби: наверно</li>
                  </ul>
                </div>
              </div>
            ...
            <div className={s.post}>
              ...
              <MyPosts message="Привет! Я зарегистрировался в новом крутом Мессенджере! Называется НеВКонтакте. Очень креативно и необычно. Никогда такого не видел"/>
              <MyPosts message="Я не сказал самое главное. Знаете кто создал это приложение на React?"/>
              <MyPosts message="Я"/>
            </div>
          </div>
        </div>
